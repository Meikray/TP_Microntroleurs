# 1 "../TP1a_leds.X/main.s"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 296 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../TP1a_leds.X/main.s" 2
PROCESSOR 18F25K40
...
PSECT code, abs
 ...
 ; PIN ((PORTC) and 0FFh), 0, a/ANC0
 ; Je veux que tu allumes LED1
 ; PIN ((PORTC) and 0FFh), 1, a/ANC1/((PORTC) and 0FFh), 1, a
 ; Je veux que tu allumes LED2
 ; PIN ((PORTC) and 0FFh), 2, a/ANC2/CCP1
 ; Je veux que tu allumes LED3
 ; PIN ((PORTC) and 0FFh), 3, a/ANC3/SCK1/SCL1
 ; Je veux que tu allumes LED4
 ; PIN ((PORTC) and 0FFh), 4, a/ANC4/SDI1/SDA1
 ; Je veux que tu allumes LED5
 ; PIN ((PORTC) and 0FFh), 5, a/ANC5
 ; Je veux que tu allumes LED6
 ; PIN ((PORTC) and 0FFh), 6, a/ANC6/TX1
 ; Je veux que tu allumes LED7
 ; PIN ((PORTC) and 0FFh), 7, a/ANC7/RX1
