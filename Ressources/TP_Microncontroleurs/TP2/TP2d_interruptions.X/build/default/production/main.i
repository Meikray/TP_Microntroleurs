...
# 109 "/Applications/microchip/mplabx/v6.25/packs/Microchip/PIC18F-K_DFP/1.14.301/xc8/pic/include/pic18_chip_select.inc" 3
# 1 "/Applications/microchip/mplabx/v6.25/packs/Microchip/PIC18F-K_DFP/1.14.301/xc8/pic/include/proc/pic18f25k40.inc" 1 3
# 47 "/Applications/microchip/mplabx/v6.25/packs/Microchip/PIC18F-K_DFP/1.14.301/xc8/pic/include/proc/pic18f25k40.inc" 3
PPSLOCK equ 0EA0h
...
CK1PPS_TX1PPS_SIZE equ 0005h
CK1PPS_TX1PPS_LENGTH equ 0005h
CK1PPS_TX1PPS_MASK equ 001Fh
...
NVMADR_ADR_POSN equ 0000h
NVMADR_ADR_POSITION equ 0000h
NVMADR_ADR_SIZE equ 0008h
NVMADR_ADR_LENGTH equ 0008h
NVMADR_ADR_MASK equ 00FFh
NVMADR_ADR0_POSN equ 0000h
NVMADR_ADR0_POSITION equ 0000h
NVMADR_ADR0_SIZE equ 0001h
NVMADR_ADR0_LENGTH equ 0001h
NVMADR_ADR0_MASK equ 0001h
NVMADR_ADR1_POSN equ 0001h
NVMADR_ADR1_POSITION equ 0001h
NVMADR_ADR1_SIZE equ 0001h
NVMADR_ADR1_LENGTH equ 0001h
NVMADR_ADR1_MASK equ 0002h
NVMADR_ADR2_POSN equ 0002h
NVMADR_ADR2_POSITION equ 0002h
NVMADR_ADR2_SIZE equ 0001h
NVMADR_ADR2_LENGTH equ 0001h
NVMADR_ADR2_MASK equ 0004h
NVMADR_ADR3_POSN equ 0003h
NVMADR_ADR3_POSITION equ 0003h
NVMADR_ADR3_SIZE equ 0001h
NVMADR_ADR3_LENGTH equ 0001h
NVMADR_ADR3_MASK equ 0008h
NVMADR_ADR4_POSN equ 0004h
NVMADR_ADR4_POSITION equ 0004h
NVMADR_ADR4_SIZE equ 0001h
NVMADR_ADR4_LENGTH equ 0001h
NVMADR_ADR4_MASK equ 0010h
NVMADR_ADR5_POSN equ 0005h
NVMADR_ADR5_POSITION equ 0005h
NVMADR_ADR5_SIZE equ 0001h
NVMADR_ADR5_LENGTH equ 0001h
NVMADR_ADR5_MASK equ 0020h
NVMADR_ADR6_POSN equ 0006h
NVMADR_ADR6_POSITION equ 0006h
NVMADR_ADR6_SIZE equ 0001h
NVMADR_ADR6_LENGTH equ 0001h
NVMADR_ADR6_MASK equ 0040h
NVMADR_ADR7_POSN equ 0007h
NVMADR_ADR7_POSITION equ 0007h
NVMADR_ADR7_SIZE equ 0001h
NVMADR_ADR7_LENGTH equ 0001h
NVMADR_ADR7_MASK equ 0080h
NVMADR_NVMADR0_POSN equ 0000h
NVMADR_NVMADR0_POSITION equ 0000h
NVMADR_NVMADR0_SIZE equ 0001h
NVMADR_NVMADR0_LENGTH equ 0001h
NVMADR_NVMADR0_MASK equ 0001h
NVMADR_NVMADR1_POSN equ 0001h
NVMADR_NVMADR1_POSITION equ 0001h
NVMADR_NVMADR1_SIZE equ 0001h
NVMADR_NVMADR1_LENGTH equ 0001h
NVMADR_NVMADR1_MASK equ 0002h
NVMADR_NVMADR2_POSN equ 0002h
NVMADR_NVMADR2_POSITION equ 0002h
NVMADR_NVMADR2_SIZE equ 0001h
NVMADR_NVMADR2_LENGTH equ 0001h
NVMADR_NVMADR2_MASK equ 0004h
NVMADR_NVMADR3_POSN equ 0003h
NVMADR_NVMADR3_POSITION equ 0003h
NVMADR_NVMADR3_SIZE equ 0001h
NVMADR_NVMADR3_LENGTH equ 0001h
NVMADR_NVMADR3_MASK equ 0008h
NVMADR_NVMADR4_POSN equ 0004h
NVMADR_NVMADR4_POSITION equ 0004h
NVMADR_NVMADR4_SIZE equ 0001h
NVMADR_NVMADR4_LENGTH equ 0001h
NVMADR_NVMADR4_MASK equ 0010h
NVMADR_NVMADR5_POSN equ 0005h
NVMADR_NVMADR5_POSITION equ 0005h
NVMADR_NVMADR5_SIZE equ 0001h
NVMADR_NVMADR5_LENGTH equ 0001h
NVMADR_NVMADR5_MASK equ 0020h
NVMADR_NVMADR6_POSN equ 0006h
NVMADR_NVMADR6_POSITION equ 0006h
NVMADR_NVMADR6_SIZE equ 0001h
NVMADR_NVMADR6_LENGTH equ 0001h
NVMADR_NVMADR6_MASK equ 0040h
NVMADR_NVMADR7_POSN equ 0007h
NVMADR_NVMADR7_POSITION equ 0007h
NVMADR_NVMADR7_SIZE equ 0001h
NVMADR_NVMADR7_LENGTH equ 0001h
NVMADR_NVMADR7_MASK equ 0080h
NVMADR_ADRL_POSN equ 0000h
NVMADR_ADRL_POSITION equ 0000h
NVMADR_ADRL_SIZE equ 0008h
NVMADR_ADRL_LENGTH equ 0008h
NVMADR_ADRL_MASK equ 00FFh
...
TOSU equ 0FFFh
# 17002 "/Applications/microchip/mplabx/v6.25/packs/Microchip/PIC18F-K_DFP/1.14.301/xc8/pic/include/proc/pic18f25k40.inc" 3
...
# 110 "/Applications/microchip/mplabx/v6.25/packs/Microchip/PIC18F-K_DFP/1.14.301/xc8/pic/include/pic18_chip_select.inc" 2 3
...
Init_PORTS:
    ...
    clrf TRISC
    BANKSEL LATC
    movlw 0x01 ; Charge la valeur 0x01 (LED C0 allumée) dans W
    movwf LATC ; Écrit 0x01 dans LATC (Initialisation du chenillard)

    ; Configuration de la broche LED de clignotement
    BANKSEL TRISB
    bcf TRISB, 4 ; Configure la led ((PORTB) and 0FFh), 4, a en sortie
    return ; Retour

Init_Variables:
    movlw 0x19 ; Charge la valeur hexadécimale 0x19 (25 décimal)
    movwf Limit_C
...
Init_Timer0: ; Configuration du Timer 0 pour un clignotement lent
    BANKSEL T0CON0
    movlw 0b10010000 ; Active TMR0 (Bit 7) et le met en mode 16 bits (Bit 4)
    movwf T0CON0
...
Init_Timer2: ; Configuration du Timer 2 (Haute priorité) pour la base de temps rapide
    ...
    movlw 0b11011001 ; Active TMR2 (Bit 7), Prescaler 1:32 (Bits 6-4), Postscaler 1:10
    movwf T2CON ; Écrit la configuration dans T2CON

    BANKSEL T2CLKCON ; Sélectionne la banque de T2CLKCON
    movlw 0b00000001 ; Sélectionne Fosc/4 comme source d'horloge
    movwf T2CLKCON ; Écrit la source dans T2CLKCON

    BANKSEL T2PR ; Sélectionne la banque de T2PR (Période Register)
    movlw 0b11111001 ; PR2 = 249 (Pour obtenir un intervalle de 5 ms)
    movwf T2PR ; Écrit la valeur maximale du compteur
    return ; Retour de sous-routine


Init_Interrupts:
    ; Configuration des priorités
    BANKSEL IPR4 ; Sélectionne la banque IPR4 (Priorité des périphériques)
    movlw 0b00000010 ; Met le bit 1 à 1 : TMR2 est en Haute Priorité
    movwf IPR4 ; Écrit la priorité

    BANKSEL IPR0 ; Sélectionne la banque IPR0
    movlw 0x00 ; TMR0 est en Basse Priorité (Bit 5 à 0 par défaut)
    movwf IPR0 ; Écrit la priorité

    ; Activation des interruptions spécifiques
    BANKSEL PIE4 ; Sélectionne la banque PIE4 (Activation des périphériques)
    movlw 0b00000010 ; Active ((PIE4) and 0FFh), 1, b (Interruption Timer 2)
    movwf PIE4 ; Écrit l'activation

    BANKSEL PIE0 ; Sélectionne la banque PIE0
    movlw 0b00100000 ; Active ((PIE0) and 0FFh), 5, b (Interruption Timer 0)
    movwf PIE0 ; Écrit l'activation

    ; Activation globale
    BANKSEL INTCON ; Sélectionne la banque INTCON
    movlw 0b11100000 ; Active ((INTCON) and 0FFh), 5, a (Priorité), ((INTCON) and 0FFh), 7, a (Global High), ((INTCON) and 0FFh), 6, a (Global Low)
    movwf INTCON ; Écrit l'activation globale
    return ; Retour de sous-routine


wait: ; Boucle principale (le microcontrôleur attend ici)
    goto wait ; Reste dans une boucle infinie, tout est géré par les interruptions
...
High_ISR:
    ; 1. Vérification du drapeau
    BANKSEL PIR4 ; Sélectionne la banque PIR4 (Drapeaux d'interruptions)
    btfss PIR4, 1 ; Teste ((PIR4) and 0FFh), 1, b (Bit 1). Si le bit est levé, saute la ligne suivante
    goto end_high ; Si le drapeau n'est pas levé, l'interruption n'est pas pour nous

    bcf PIR4, 1 ; Efface le drapeau ((PIR4) and 0FFh), 1, b pour permettre la prochaine interruption

    ; 2. Logique du Chenillard (ralentie par le compteur logiciel)
    INCF compteur_1 , F ; Incrémente le compteur logiciel (F = stocker le résultat dans le fichier)

    movf compteur_1 , W ; Charge la valeur du compteur dans le registre W
    CPFSEQ Limit_C ; Compare W à Limit_C. Si W est ÉGAL, la ligne suivante est SAUTÉE
    goto end_high ; Si W N'EST PAS ÉGAL, on sort (on attend la prochaine interruption)

    ; 3. Mouvement du Chenillard (exécuté uniquement quand le seuil est atteint)
    BANKSEL LATC ; Sélectionne la banque LATC
    rlncf LATC, F ; Rotation à gauche sans carry du PORTC (déplace la LED)

    clrf compteur_1 ; Réinitialise le compteur logiciel à zéro

end_high:
    retfie ; Retour d'interruption (restauration automatique du contexte)


Low_ISR:
    ; 1. Vérification du drapeau
    BANKSEL PIR0 ; Sélectionne la banque PIR0
    btfss PIR0, 5 ; Teste ((PIR0) and 0FFh), 5, b (Bit 5). Si le bit est levé, saute la ligne suivante
    goto end_low ; Si le drapeau n'est pas levé, on sort

    bcf PIR0, 5 ; Efface le drapeau ((PIR0) and 0FFh), 5, b

    ; 2. Recharger Timer0 (Le timer 0 n'est pas rechargé automatiquement)
    BANKSEL TMR0H ; Sélectionne la banque TMR0H
    movlw 0xFF ; Charge la partie haute
    movwf TMR0H ; Écrit dans TMR0H
    movlw 0x13 ; Charge la partie basse
    movwf TMR0L ; Écrit dans TMR0L pour recharger le timer complet (16 bits)

    ; 3. Action : Toggle de la LED ((PORTB) and 0FFh), 4, a
    BANKSEL LATB ; Sélectionne la banque LATB
    btg LATB, 4 ; Inverse l'état du bit 4 (allume/éteint la LED)

end_low:
    retfie ; Retour d'interruption (restauration manuelle si nécessaire, mais ici le contexte est simple)
