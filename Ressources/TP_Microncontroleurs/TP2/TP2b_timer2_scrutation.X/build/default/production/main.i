...
; Table des I/O ================================================================
; LED LED0 à la pin ((PORTC) and 0FFh), 0, a
...
Init_MATRIX:
    BANKSEL TRISB
    bcf TRISB,4 ; ((PORTC) and 0FFh), 0, a en sortie
...
init_2:
    ...
    BANKSEL T2CON
    movlw 0b10000000 ; ((T2CON) and 0FFh), 7, a = 1 (timer activé)
    addlw 0b01010000 ; Prescaler = 1:1
    addlw 0b00000100 ; Postscaler = 1:1
    movwf T2CON

    BANKSEL T2CLKCON
    movlw 0b00000001 ; Source = Fosc/4
    movwf T2CLKCON

    BANKSEL PIR4
    bcf PIR4, 1 ; Effacer flag ((PIR4) and 0FFh), 1, b
...
loop:
    ...
    BANKSEL PIR4 ; Sélection du registre PIR0
    btfss PIR4,1 ; Test si le flag Timer0 (((PIR0) and 0FFh), 5, b) est à 1
    goto loop ; Retourne au début de la boucle si sa ne marche pas

    bcf PIR4,1 ; effacer le flag ((PIR0) and 0FFh), 5, b si sa marche
