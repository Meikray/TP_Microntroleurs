...
Init_MATRIX:
    BANKSEL TRISB
    bcf TRISB,5 ; Mettre ((PORTB) and 0FFh), 5, a en sortie (LED_MATRIX)
    return
...
init_inter:
    BANKSEL PIE4
    movlw 0b00000010 ;((PIE4) and 0FFh), 1, b = 1 (bit 1 de PIE4). Active l'interruption du Timer 2.
    movwf PIE4

    BANKSEL INTCON
    movlw 0b10100000 ; on enable ((INTCON) and 0FFh), 5, a et les hautes interrupts
    movwf INTCON

    BANKSEL IPR4
    movlw 0b00000010 ;((IPR4) and 0FFh), 1, b = 1 (bit 1 de IPR4). Définit l'interruption TMR2 en HAUTE PRIORITY.
    movwf IPR4
