...
init:
    ...
    bcf TRISB,4 ; Met ((PORTB) and 0FFh), 4, a en sortie
...
loop:
    ...
    btfss PIR0,5 ; Test si le flag Timer0 (((PIR0) and 0FFh), 5, b) est à 1
    goto loop ; Retourne au début de la boucle si sa ne marche pas

    bcf PIR0,5 ; effacer le flag ((PIR0) and 0FFh), 5, b si sa marche
