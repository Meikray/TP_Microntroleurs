...
FINAL_IMAGE=${DISTDIR}/TP1c_softchenillard_.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/TP1c_softchenillard_.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC18F25K40
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/TP1c_softchenillard_.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/TP1c_softchenillard_.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC18F25K40 ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/TP1c_softchenillard_.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
