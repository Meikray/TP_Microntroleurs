...
Init_PORTS_PWM:
    ...
    bcf TRISC, 0 ; Configure ((PORTC) and 0FFh), 0, a en sortie


    bcf TRISC, 1; ((PORTC) and 0FFh), 1, a en sortie
    bcf LATC, 1
    return
...
Init_Timer2_PWM:
    ...
    BANKSEL T2CON
    movlw 0b11011111; ((T2CON) and 0FFh), 7, a=1, Prescaler 1:32, Postscaler 1:16
    movwf T2CON
...
Init_PWM3:
    ...
    BANKSEL PWM3CON
    movlw 0b10000000; ((PWM3CON) and 0FFh), 7, a=1
